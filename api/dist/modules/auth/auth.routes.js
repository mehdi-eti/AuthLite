...
router.post("/login-with-email", (0, validate_middleware_1.default)(auth_schema_1.loginWithEmailSchema), auth_controller_1.loginWithEmail);
...
router.get("/me", authenticate_1.authenticate, auth_controller_1.meController);
