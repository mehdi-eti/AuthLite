...
# **Signetic - سیستم احراز هویت مدرن**

![Signetic Logo](https://via.placeholder.com/150x50?text=Signetic)

**Signetic** یک سیستم احراز هویت (**Auth**) ساده، امن و قابل توسعه است که با **React** در فرانت‌اند و **Express.js** در بک‌اند ساخته شده است. این پروژه از روش‌های مختلف ورود مانند **ایمیل، شماره موبایل، احراز هویت گوگل و...** پشتیبانی می‌کند و برای برنامه‌های **وب و موبایل** مناسب است.
